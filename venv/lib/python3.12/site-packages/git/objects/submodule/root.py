...
class RootUpdateProgress(UpdateProgress):
    ...
    REMOVE, PATHCHANGE, BRANCHCHANGE, URLCHANGE = [1 << x for x in range(
...
class RootModule(Submodule):
    ...
    def __init__(self, repo: "Repo") -> None:
        # repo, binsha, mode=None, path=None, name = None, parent_commit=None,
        # url=None, ref=None)
        super().__init__(
            repo,
                ...
                if sm.module_exists():
                    ...
                    if sm.url != psm.url:
                        ...
                        if len([r for r in rmts if r.url == sm.url]) == 0:
                            progress.update(
                                BEGIN | URLCHANGE, i, len_csms, prefix + "Changing url of submodule %r from %s to %s" %
                            ...
                            if not dry_run:
                                ...
                                if len([r for r in smr.refs if r.remote_head ==
                                       sm.branch_name]) == 0:
                                    raise ValueError(
