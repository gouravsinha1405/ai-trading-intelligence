...
class Commit(base.Object, TraversableIterableObj, Diffable, Serializable):
    ...
    def _iter_from_process_or_stream(
            cls, repo: "Repo", proc_or_stream: Union[Popen, IO]) -> Iterator["Commit"]:
        ...
        # return hasattr(proc_or_stream, 'wait') and not hasattr(proc_or_stream,
        # 'readline')
    ...
    def _deserialize(self, stream: BytesIO) -> "Commit":
        ...
        while True:
            ...
            self.parents.append(type(self)(self.repo,
