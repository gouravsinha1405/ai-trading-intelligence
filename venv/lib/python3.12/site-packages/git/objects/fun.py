...
def tree_to_stream(entries: Sequence[EntryTup], write: Callable[[
                   "ReadableBuffer"], Union[int, None]]) -> None:
    ...
    for binsha, mode, name in entries:
        ...
        if isinstance(name, str):
            ...
            # type: ignore[unreachable]  # check runtime types - is always str?
            name_bytes = name
