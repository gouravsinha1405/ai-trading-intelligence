...
class SymbolicReference:
            ...
            with open(cls._get_packed_refs_path(repo), "rt", encoding="UTF-8") as fp:
                for line in fp:
                    ...
                    if line.startswith("#"):
                        ...
                        if line.startswith(
                                "# pack-refs with:") and "peeled" not in line:
                            raise TypeError(
    ...
    def dereference_recursive(
            cls, repo: "Repo", ref_path: Union[PathLike, None]) -> str:
        """
        :return:
    ...
    def _get_ref_info_helper(
        ...
        try:
            ...
            # 60b64ef992065e2600bfef6187a97f92398a9144                branch 'master'
            # of git-server:/path/to/repo
            tokens = value.split()
            assert len(tokens) != 0
        except OSError:
    ...
    @classmethod
    def _get_ref_info(cls,
                      repo: "Repo",
                      ref_path: Union[PathLike,
                                      None]) -> Union[Tuple[str,
                                                            None],
                                                      Tuple[None,
                                                            str]]:
        """
    ...
    def log_append(
        ...
        try:
            committer_or_reader: Union["Actor",
                                       "GitConfigParser"] = self.commit.committer
        except ValueError:
    ...
    def iter_items(
        ...
        **kwargs: Any,
        ...
        """
        return (r for r in cls._iter_items(repo, common_path)
    ...
    def from_path(
        ...
        raise ValueError(
            "Could not find reference type suitable to handle path %r" %
            path)
