...
class PushInfo(IterableObj):
    ...
    def old_commit(self) -> Union["Commit", None]:
        return self._old_commit_sha and self._remote.repo.commit(
            self._old_commit_sha) or None
    ...
    def iter_items(
            ...
            repo: "Repo",
            *args: Any,
            **kwargs: Any) -> NoReturn:  # -> Iterator['PushInfo']:
...
class FetchInfo(IterableObj):
    ...
    def iter_items(
            ...
            repo: "Repo",
            *args: Any,
            **kwargs: Any) -> NoReturn:  # -> Iterator['FetchInfo']:
        raise NotImplementedError
